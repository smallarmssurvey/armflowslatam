...
card(
  ...
  card_image(file ="images/profiles/03_monica.jpeg",
             ...
             class="profile"),
  card_body(
    markdown("Monica Herz is a professor at the Pontifical Catholic University of Rio de Janeiro’s Institute of International Relations. She has a PhD degree from the London School of Economics and Political Science and has written books, chapters and articles about Latin American Security, regional and global governance and Brazilian foreign Policy."), class="hover-info"),
  card_footer(
...
card(
  ...
  card_image(file ="images/profiles/08_bruno.jpg", 
             alt = "Bruno Langeani", 
             class="profile"),
  card_body(markdown("Bruno Langeani is a Data Analyst at Conflict Armament Research (CAR), where he cleans, harmonises and interrogates multi-regional datasets to map illicit-weapons flows and support CAR’s research and policy work.

As Senior Consultant to the Sou da Paz Institute, he leads studies on gun-control regulation, firearms and ammunition profiling, and tracing. As a specialist in public-security research, Bruno has published widely on firearms diversion and armed violence, including the book Arma de Fogo no Brasil: Gatilho da Violência (2021).

For the UNODC Global Firearms Programme he served as a firearms expert evaluating programme impact, while for the OAS Programme of Assistance on Control of Arms and Munition (PACAM) he delivered legislative gap analyses and provided technical assistance and capacity-building covering the full life-cycle management of firearms and ammunition across the Americas."), class="hover-info"),
  card_footer(
...
card(
  ...
  card_image(file ="images/profiles/11_magda.jpeg", 
             alt = "Magda Coss", 
             class="profile"),
  card_body(markdown("Magda Coss is a consultant, author, and founder with extensive expertise in gender-violence prevention, gender equality, and gun violence prevention. She has designed and implemented communication strategies and campaigns on these issues in over 15 countries, drawing on her strong background in international communications. Magda is the founder of 24-0 Mexico, an NGO advancing civilian disarmament and peace-building policies.

As an author, Magda’s publications include the acclaimed book Firearms
Trafficking in Mexico: Corruption, Weaponism, and the Culture of Violence,
published by Random House, as well as research analyzing the effects of small arms and gun violence. Her recent work, Understanding the Gendered Impacts of Urban Gun Violence, was produced in collaboration with Pathfinders and Peace in Our Cities.

Previously, Magda served as Chief of Staff to the president of Mexico’s National Institute for Women (INMUJERES), and is an active participant in key gun control networks. She is also the founder and president of Inspiring Girls Mexico, an initiative empowering girls and teenagers to fulfill their aspirations. Currently, through her consultancy IGMX, Magda provides expert guidance on violence prevention and the promotion of gender equality in both local and international projects."), class="hover-info"),
card_footer(
