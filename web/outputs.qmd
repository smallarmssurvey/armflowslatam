...
card(
  ...
  card_footer(
    markdown("<a href='https://www.smallarmssurvey.org/resource/authorized-trade-small-arms-latin-america-global-perspective' target='_blank'>More about the article</a>"), 
    class="more-info"),
  class="output-card"),
card(
  full_screen = TRUE,
