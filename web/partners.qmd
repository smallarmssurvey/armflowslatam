...
The project also cooperates with regional research institutions, including [**Instituto Sou da Paz**](https://soudapaz.org/){target="_blank"}, the [**State University of Rio de Janeiro**](https://www.uerj.br/){target="_blank"} (UERJ) [**Laboratório de Análise da Violência**](https://lav-uerj.org/en/institucional/){target="_blank"}, and the [**Conflict Analysis Resource Center**](https://iansa.org/member/the-conflict-analysis-resource-center-cerac/){target="_blank"} (CERAC), as well as with the [**Organization of American States**](https://www.oas.org/){target="_blank"} (OAS).
