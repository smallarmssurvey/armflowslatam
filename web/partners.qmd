...
card(
  full_screen = F,
   tags$a(
     href = "https://laboratoriodehumanidadesdigitais.usuarios.rdc.puc-rio.br/en/home-english/about-puc-rios-digital-humanities-lab-dhlab",
     target = "_blank",
...
The project also cooperates with regional research institutions, including [**Instituto Sou da Paz**](https://soudapaz.org){target="_blank"}, [**Laboratório de Análise da Violência of the State University of Rio de Janeiro**](https://lav-uerj.org/){target="_blank"} (UERJ) [**Laboratório de Análise da Violência**](https://lav-uerj.org/en/institucional/){target="_blank"}, **IGMX Consulting and Research for Equality** (IGMX), and the [**Conflict Analysis Resource Center**](https://www.cerac.org.co){target="_blank"} (CERAC), as well as with the [**Organization of American States**](https://www.oas.org){target="_blank"} (OAS).

```{r}
#| warn: false
#| message: false
#| echo: false
layout_column_wrap( width = 1/4, gap="20px", fill=T,
card(full_screen = F,
     tags$a(
...
card(full_screen = F,
     tags$a(
     href = "https://lav-uerj.org/",
     target = "_blank",
  card_image(file ="images/Institutions/08_lav.png", 
             alt = "Laboratório de Análise da Violência of the State University of Rio de Janeiro",
             height="40%",
             class="institution-image")),
  class="institution-card"),
card(full_screen = F,
...
card(full_screen = F,
  tags$a(
     href = "",
     target = "_blank",
  card_image(file ="images/Institutions/07_igmx.png", 
             alt = "IGMX",
             #width="100%",
             class="institution-image"
             )),  class="institution-card"),
