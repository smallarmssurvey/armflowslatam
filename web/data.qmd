...
layout_column_wrap( width = 1/3, gap="20px", fill=T, fillable=T,
  card(full_screen=T,
       ...
       card_body("The United Nations Comtrade database aggregates detailed global annual and monthly trade statistics by product and trading partner.", class = "text"), 
       class="data-card")
)
```
